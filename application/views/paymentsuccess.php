...
<center><img src="<?= base_url()?>app-assets/assets/img/success.gif" class="img img-responsive giphy-embed"/></center>
                <div class="error-txt-box">
        <h2 class="error-heading">Booking Successfull !!</h2>
        
                <p class="error-para">We will Reach You soon </p>
    </div>
    ...
    <a href="<?= base_url() ?>"><button type="button"class=" btn btn-md">Back to Home</button></a>
    </div>
